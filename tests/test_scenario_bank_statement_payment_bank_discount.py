...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(customer_invoice.state
        , 'posted'
        )
        ...
        self.assertEqual(payment.amount
        , Decimal('100.00')
        )
        ...
        receivable.reload()
        self.assertEqual(receivable.balance
        , Decimal('100.00')
        )
        ...
        self.assertEqual(st_move_line.amount
        , Decimal('100.00')
        )
        self.assertEqual(st_move_line.account.name
        , 'Customers Bank Discount'
        )
        self.assertEqual(st_move_line.party.name
        , 'Customer'
        )
        statement_line.save()
        ...
        self.assertEqual(customer_bank_discounts.balance
        , Decimal('-100.00')
        )
        ...
        self.assertEqual(statement2.state
        , 'confirmed'
        )
        ...
        self.assertEqual(statement3.state
        , 'confirmed'
        )
        ...
        self.assertEqual(customer_invoice2.state
        , 'posted'
        )
        ...
        self.assertEqual(customer_invoice3.state
        , 'posted'
        )
        receivable.reload()
        self.assertEqual(receivable.balance
        ...
        self.assertEqual(payment2.amount
        , Decimal('200.00')
        )
        payment2.click('submit')
        self.assertEqual(payment2.state
        , 'submitted'
        )
        ...
        self.assertEqual(payment3.amount
        , Decimal('80.00')
        )
        payment3.click('submit')
        self.assertEqual(payment3.state
        , 'submitted'
        )
        ...
        self.assertEqual(statement4.state
        , 'confirmed'
        )
        ...
        self.assertEqual(statement5.state
        , 'confirmed'
        )
        ...
        self.assertEqual(customer_bank_discounts.balance, Decimal('-80.00'))
        self.assertEqual(cash.balance, Decimal('380.00'))
