...
requires += [get_require_version('trytond_account_payment'),get_require_version('trytond_account_payment_clearing')]
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_bank_statement_payment',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_bank_statement_payment'
    },
    classifiers=[
